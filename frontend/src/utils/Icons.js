...
export const calender=<i className="fa-regular fa-calendar-days"></i>
export const ruppee=<i className="fa-solid fa-rupee-sign"></i>
export const data=<i className="fa-sharp fa-solid fa-calendar-week"></i>
export const comment=<i className="fa-solid fa-comment"></i>
export const des=<i className="fa-solid fa-audio-description"></i>
export const trashing=<i className="fa-solid fa-trash"></i>
